                ...
                if (cartItems.isEmpty) {
                  ...
                  CoolAlert.show(
                      ...
                      confirmBtnTextStyle: TextStyle(
                          ...
                          color: myWhite),
                      title: "Table no: $tableNameGlobal",
                      text: userResponse["full_name"]
                                  .toString()
                                  .toUpperCase() ==
                              "FLOORMANAGER"
                          ? "Order against Table $tableNameGlobal by ${userResponse["full_name"].toString().toUpperCase()}"
                          : "Order against Table $tableNameGlobal with assigned waiter ${userResponse["full_name"].toString().toUpperCase()}",
                      showCancelBtn: true,
